...
export default function Page() {
  ...
  return (
    <main className="min-h-screen bg-[#ffffff] text-[#222222]">
      ...
      <header className="sticky top-0 z-30 border-b border-[#eeeeee]/80 bg-[#ffffff]/95 backdrop-blur-md">
      ...
      <section id="about-us" className="border-y border-[#eeeeee] bg-[#ffffff] px-5 py-16 lg:px-8 lg:py-20"><div className="mx-auto grid max-w-7xl gap-12 lg:grid-cols-[0.85fr_1.15fr] lg:items-end"><div><p className="eyebrow">Who we are</p><h2 className="section-title mt-4">Good change starts with <em>good listening.</em></h2></div><div><p className="max-w-xl text-lg leading-8 text-[#555555]">We are a humanitarian and development organization working alongside people experiencing hardship. Our work is locally led, transparent, and focused on what communities say they need most.</p><a href="#about" className="mt-6 inline-flex items-center gap-2 text-sm font-semibold text-[#E76F24]">Learn about Imaan Relief <ArrowUpRight size={16} /></a></div></div></section>
